...
Before joining NYU, I completed my PhD at the [Technische Universität München](https://www.tum.de/) and the [Max Planck Institute for Plasma Physics](https://www.ipp.mpg.de/) in the [Numerical Methods for Plasma Physics division](https://www.ipp.mpg.de/ippcms/eng/for/bereiche/numerik) with Michael Kraus and Eric Sonnendrücker. Before that, I obtained an MSc in Physics, BSc in Engineering Science from TUM and a BSc in Psychology from the University of Bamberg.
